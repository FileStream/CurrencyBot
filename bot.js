    ...
    if (message.substring(0, 2) == 'x!' && (!isDeaf || userID == creator_id)) {
        ...
        switch (cmd) {
            ...
            case 'getdata':
                ...
                break;
            case 'de':
                //    if (userID!='571820647370588170'&&userID!=creator_id) break;
                bot.deleteMessage({
                    channelID: channelID,
                    messageID: evt.d.id
                });
                //  var guild = bot.channels[channelID].guild_id;
                var guild = '574600140384370699';
                    ...
                    if (!args[1]) {
                        ...
                        bot.sendMessage({
                            ...
                            embed: {
                                ...
                                "description": Sstring,
                                "footer": {
                                    "text": "x!use <item #> to use items, x!items <page #> to switch pages.\n\nPage 1/" + pageHolder[channelID].text.length
                                }
                            }
...
bigInteger.prototype.toDisplayString = getCommas.apply(this);
